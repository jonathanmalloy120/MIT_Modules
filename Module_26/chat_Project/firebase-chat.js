(function () {
  ...
  var firebaseConfig = {
    apiKey: "AIzaSyAROnVvwnuoZUqDowAgU1koKoWWd1h2wsA",
    authDomain: "chat-bd082.firebaseapp.com",
    databaseURL: "https://chat-bd082-default-rtdb.firebaseio.com",
    projectId: "chat-bd082",
    storageBucket: "chat-bd082.appspot.com",
    messagingSenderId: "4366281177",
    appId: "1:4366281177:web:7186e5520cf5f3eeb051c8"
  };
  // Initialize Firebase
  ...
  messagesRef.on('value',(snapshot) => {
    handleRead(); //only need to handleread as function to do the update is already done. just setting trigger
  })
